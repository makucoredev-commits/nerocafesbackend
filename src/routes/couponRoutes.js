...
router.post('/validate', async (req, res) => {
  try {
    ...
    // Check branch scope
    if (coupon.scope === 'BRANCH_SPECIFIC' && coupon.branchId && coupon.branchId !== req.branchId) {
      return res.json({ valid: false, message: 'This promo code is not valid for this NeroCafes branch.' });
    }
